...
import advent_of_code.year_2023.day_03.solution as s03
...
class TestSolution(unittest.TestCase):
    """Tests for the solution of puzzle 2023-03."""
    ...
    def test_aoc_verified_part_1(self):
        ...
        self.assertEqual(actual, 539433)
    ...
    def test_aoc_verified_part_2(self):
        ...
        self.assertEqual(actual, 75847567)
