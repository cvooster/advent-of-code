...
import advent_of_code.year_2023.day_04.solution as s04
...
class TestSolution(unittest.TestCase):
    """Tests for the solution of puzzle 2023-04."""
    ...
    def test_aoc_verified_part_2(self):
        ...
        self.assertEqual(actual, 13261850)
