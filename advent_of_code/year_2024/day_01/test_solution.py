...
import advent_of_code.year_2024.day_01.solution as s01
...
class TestSolution(unittest.TestCase):
    """Tests for the solution of puzzle 2024-01."""
    ...
    def test_aoc_verified_part_1(self):
        ...
        self.assertEqual(actual, 2057374)
    ...
    def test_aoc_verified_part_2(self):
        ...
        self.assertEqual(actual, 23177084)
