...
import advent_of_code.year_2019.day_04.solution as s04

FILENAME = "input.txt"
FILENAMES_EXAMPLES = tuple(f"input_example_{i+1}.txt" for i in range(6))


class TestSolution(unittest.TestCase):
    """Tests for the solution of puzzle 2019-04."""
