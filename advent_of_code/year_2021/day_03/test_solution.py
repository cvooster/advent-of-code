...
import advent_of_code.year_2021.day_03.solution as s03
...
class TestSolution(unittest.TestCase):
    ...
    def test_aoc_verified_part_2(self):
        ...
        self.assertEqual(actual, 1662846)
